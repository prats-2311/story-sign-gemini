...
## What it does
StorySign is a real-time multimodal AI platform. Our flagship module, **Reconnect**, is a fully functional AI Physical Therapist that serves as a:

*   **Real-Time Biomechanics Coach:** Uses computer vision to track skeletal landmarks at 60 FPS.
*   **Active Counter & Form Corrector:** Automatically counts repetitions (e.g., "Five!") and detects specific form errors (e.g., "Keep your back straight") using a deterministic physics engine.
*   **Safety Monitor:** Integreates a sophisticated `[SAFETY_STOP]` system. If it detects high-velocity spasms or dangerous ranges of motion, it interrupts immediately before the AI even finishes its sentence.
*   **Clinical Reporter:** Uses **Gemini 3.0** ("Deep Think") to analyze the session's telemetry and generate a professional progress report for human therapists.
